...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '127.0.0.1,localhost,auction-platform-rfg1.onrender.com').split(',')
...
USE_I18N = True
USE_TZ = True
CSRF_TRUSTED_ORIGINS = ['https://auction-platform-rfg1.onrender.com']
